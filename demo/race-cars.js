/* The three race cars, balanced to lap within a few tenths of each other on the City Circuit (each keeps its own
   ...
   heavy, four-wheel-drive and turbocharged). `tune` goes straight into CAR.create(); `engine` is the recorded sound pack (your car), `synth` the
   built-in engine sound (the AI cars, car/sound). */
export const RACE_CARS = [
  {
    ...
    preset: 'sport', tune: { power: 360, mass: 1400, grip: 1.45, topSpeed: 290 }, engine: 'f136', synth: 'v8', turbo: false,
  },
  {
    id: 'vaz', name: 'VAZ 2107', file: '/assets/models/test/vaz_2107.glb', blurb: 'RWD · light · best in the old town',
    preset: 'classic', tune: { power: 320, mass: 1000, grip: 1.56, topSpeed: 285, gears: 5, redline: 7500, stiffness: 1.4, antiRoll: 0.5 }, engine: 'vtec', synth: 'inline4', turbo: false,
  },
  {
    id: 'dirty', name: 'Dirty car', file: '/assets/models/test/dirty_car.glb', blurb: 'AWD · turbo · strong out of corners',
    preset: 'car', tune: { power: 380, mass: 1550, grip: 1.42, topSpeed: 280, drive: 'awd' }, engine: '2jz', synth: 'inline6', turbo: true,
  },
];
